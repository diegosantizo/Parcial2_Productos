  ...
  <body>
    ...
    <div class="container">
      ...
      <table class="table table-striped table-inverse table-responsive">
        ...
        <tbody id="InvProductos">
          ...
          $resultado = $db_conexion->use_result();
          while ($fila = $resultado->fetch_assoc()) {
            echo "<tr data-id=" . $fila['idProducto'] . " data-idMarca=" . $fila['idmarcas'] . ">";
    ...
    <script type="text/javascript">
      ...
      $('#Productos').on('click', 'tr td', function(evt) {
        var target, idproducto, idp, producto, marca, Descripcion, precio_costo, precio_venta, existencia;
        target = $(event.target);
        ...
        $("#txt_marca").val(marca);
        $("#txt_descripcion").val(Descripccion);
