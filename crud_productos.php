    ...
    if( !empty($_POST) ){
       ...
       $txt_id = utf8_decode($_POST["txt_id"]);
        ...
        if(isset($_POST['btn_agregar'])  ){
          ...
          $sql = "UPDATE Productos SET producto='". $txt_producto ."',marca='". $drop_marca ."',Descripcion='". $txt_Descripcion ."',precio_costo='". $txt_costo ."',precio_venta='". $txt_venta ."',existencia='". $txt_existencia ." where producto = ". $txt_producto.";";
        }else if( isset($_POST['btn_eliminar'])  ){
          $sql = "DELETE FROM Productos  WHERE producto = ". $txt_producto.";";
        }else if ($db_conexion->query($sql)===true){
            $db_conexion->close();
