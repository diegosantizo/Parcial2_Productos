    ...
    if( !empty($_POST) ){
       ...
       $txt_id = utf8_decode($_POST["txt_id"]);
        ...
        if(isset($_POST['btn_agregar'])){  
          ...
          $sql = "UPDATE InvProductos.Productos SET producto='". $txt_producto ."',marca=". $drop_marca .",Descripcion='". $txt_descripcion .",precio_costo=". $txt_costo .",precio_venta=". $txt_venta .",existencia=". $txt_existencia ." where idProducto = ". $txt_id.";";
